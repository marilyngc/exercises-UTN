...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        ...
        conversor_f = (temperatura_c * 9/5) + 32;
        
        alert("Fahrenheit a Centígrados", f" El valor de {temperatura_c} a centígrados es: {conversor_f}");
    ...
    def btn_convertir_f_c_on_click(self):
        ...
        conversor_c = (temperatura_f - 32) * 5/9;
        
        alert("Fahrenheit a Centígrados", f" El valor de {temperatura_f} a centígrados es: {conversor_c}");
